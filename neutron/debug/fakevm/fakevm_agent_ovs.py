...
class NeutronFakeVMAgentOVS(
    ...
    def __init__(self):
        super(NeutronFakeVMAgentOVS, self).__init__()
        self.conf = None
        self.root_helper = None
        self.int_br = None

    def init(self, conf):
        super(NeutronFakeVMAgentOVS, self).init(conf)
...
cfg.CONF.register_opts(NeutronFakeVMAgentOVS.OPTS, 'FAKEVM')
