...
class NeutronFakeVMAgentPluginBase(object):
    ...
    OPTS = [
        ...
        cfg.BoolOpt('enable_multi_node_emulate', default=False,
                    help=_('Enable the multiple node emulation')),
    ]

    DEV_NAME_LEN = 13   # NOTE(yamahata): for dhclient
                        # != neutron.agent.linux.interface.DEV_NAME_LEN = 14
...
cfg.CONF.register_opts(NeutronFakeVMAgentPluginBase.OPTS, 'FAKEVM')
