...
class NeutronFakeVMAgentLB(
        fakevm_agent_plugin_base.NeutronFakeVMAgentPluginBase):

    def __init__(self):
        super(NeutronFakeVMAgentLB, self).__init__()
        self.conf = None
        self.root_helper = None

    def init(self, conf):
        super(NeutronFakeVMAgentLB, self).init(conf)
    ...
    def _make_vif_args(self, instance_id, network_id, vif_uuid, mac,
        ...
        interface, vif = super(NeutronFakeVMAgentLB, self)._make_vif_args(
