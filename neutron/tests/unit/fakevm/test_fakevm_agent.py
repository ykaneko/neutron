...
from neutron.debug.fakevm import fakevm_agent
from neutron.tests import base


_AGENT_NAME = 'neutron.debug.fakevm.fakevm_agent'
...
class TestFakeVMAgent(base.BaseTestCase):
    def setUp(self):
        ...
        self.neutron_rpc = mock.patch(_AGENT_NAME + '.rpc').start()
        ...
        self.neutron_rpc.create_connection = mock.Mock(
    ...
    def mock_agent(self):
        return fakevm_agent.NeutronFakeVMAgent(self.conf)
    ...
    def test_instantiate(self):
        ...
        self.neutron_rpc.assert_has_calls([
    ...
    def test_main(self):
        ...
        with mock.patch(_AGENT_NAME + '.NeutronFakeVMAgent',
        ...
        self.mock_cfg.assert_has_calls([
            mock.call.CONF(project='neutron')
        ])
