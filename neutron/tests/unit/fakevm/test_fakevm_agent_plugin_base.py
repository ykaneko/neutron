...
_AGENT_NAME = 'neutron.debug.fakevm.fakevm_agent_plugin_base'


class FakeVMAgentPlugin(fakevm_agent_plugin_base.NeutronFakeVMAgentPluginBase):
    ...
    def test_ensure_bridge(self):
        ...
        with nested(
            mock.patch(_AGENT_NAME +
                       '.NeutronFakeVMAgentPluginBase._device_exists',
                       return_value=False),
            mock.patch(_AGENT_NAME + '.utils.execute'),
