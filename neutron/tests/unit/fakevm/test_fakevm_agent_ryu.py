...
_AGENT_NAME = 'neutron.debug.fakevm.fakevm_agent_ryu'
...
class TestFakeVMAgentRyu(base.BaseTestCase):
    def setUp(self):
        ...
        self.ovs_lib = mock.patch(
            'neutron.debug.fakevm.fakevm_agent_plugin_base.ovs_lib').start()
        ...
        self.ryu_agent = mock.patch(
            _AGENT_NAME + '.ryu_neutron_agent').start()
    ...
    def mock_plugin(self):
        ...
        return self.mod_plugin.NeutronFakeVMAgentRyu()
